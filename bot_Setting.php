...
<div class="flex h-full">
    ...
    <main class="flex-1 overflow-y-auto p-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div id="profile-box" class="bg-white rounded-lg shadow-md overflow-hidden <?php echo $isLoggedIn ? "" : "hidden"; ?>">
            ...
            <div id="qr-box" class="bg-white rounded-lg shadow-md overflow-hidden <?php echo $isLoggedIn ? "hidden" : ""; ?>">
                <div class="p-6 bg-gray-50 border-b">
            ...
            <div id="login-box" class="bg-white rounded-lg shadow-md overflow-hidden <?php echo $isLoggedIn ? "" : "hidden"; ?>">
                <div class="p-6 bg-gray-50 border-b">
            ...
            <div class="bg-white rounded-lg shadow-md">
                ...
                <div class="p-6 space-y-4">
                    <div class="flex justify-between border-b pb-4">
                        <span>Status</span>
                        <span class="px-4 py-1 rounded-full text-white <?php echo $isLoggedIn ? "bg-green-500" : "bg-yellow-500"; ?>">
...
<div id="modal-edit-name" class="hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
    <div class="bg-white rounded-lg shadow-xl max-w-sm w-96 p-6 animate-in fade-in zoom-in">
        ...
        <div class="flex gap-3">
            <button id="btn-modal-cancel" class="flex-1 bg-gray-300 hover:bg-gray-400 text-gray-800 font-semibold py-2 px-4 rounded-lg transition">Batal</button>
            <button id="btn-modal-save" class="flex-1 bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded-lg transition">Simpan</button>
        </div>
    </div>
</div>
