...
// --- QUERY DATABASE ---
$sql = "SELECT w.group_id, g.group_name, g.description 
...
<div class="w-64 bg-slate-800 text-white p-0 overflow-y-auto shadow-lg">
    ...
    <nav>
        <ul class="list-none m-0 p-0">
            ...
            <li class="m-0"><a href="#" class="block p-4 text-white no-underline transition-all duration-300 border-l-4 border-transparent hover:bg-slate-700 hover:border-l-blue-400">⚙️ Bot Settings</a></li>
